  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        'scroll-reveal': 'scroll-reveal 0.8s cubic-bezier(0.23, 1, 0.320, 1) forwards',
      },
      keyframes: {
        float: {
      ...
      boxShadow: {
        ...
        'neomorph': '9px 9px 18px #d1d1d4, -9px -9px 18px #ffffff',
        'neomorph-dark': '9px 9px 18px #1e1e20, -9px -9px 18px #3c3c40',
